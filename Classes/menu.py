...
class menu:
    ...
    def __random_test_grid(dir_name, random_idx):
        ...
        test_pcpds = fm.load(os.path.join(dir, str(random_idx) +'.json')) #
        return [test_pcpds, random_idx]

    # Choice 1: Select an unknown grid and test against all points
    def random_idx_normal(self, collection_path, n_results):
    ...
    def manual_idx_normal(self, collection_path, n_results):
    ...
    def random_idx_rotated(self, collection_path, n_results):
